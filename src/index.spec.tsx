  ...
  it('reactElementToJSXString forwardRef with a displayName', () => {
    const createReactComponent = tagName => {
      const createForwardRef = ReactComponent => {
        const forwardRef = (props, ref) => <ReactComponent {...props} forwardedRef={ref} />;
...
/>`
  ...
  it("reactElementToJSXString(<div>{''}</div>)", () => {
    expect(reactElementToJSXString(<div />)).toEqual(
  ...
  it('reactElementToJSXString(<TestComponent />, { useBooleanShorthandSyntax: false })', () => {
    expect(
      reactElementToJSXString(
        <TestComponent testTrue testFalse={false} />,
        {
...
>
  ...
  it('reactElementToJSXString(<Fragment />)', () => {
    expect(reactElementToJSXString(<></>)).toEqual(`<React.Fragment />`);
  });
